	...
	class Base {
		public:
			class Task {
				...
				public:
					Task(cl_context Context, cl_command_queue Queue, size_t MaxBlockSize);
					...
					virtual void EnqueueExecution(cl_uint StartIteration, cl_uint BlockSize, cl_float TimeDelta, cl_uint WaitEventCount, const cl_event* WaitEvents, cl_event* CompletionEvent) =0;
			...
			virtual Task* CreateTask(Object::Base* Object, cl_uint MaxBlockSize) =0;
			virtual ~Base();
	};
}
